(function (global) {
  ...
  describe('basic test', function () {
    ...
    it('ua.xbox.trident', function () {
      useragents['XboxTrident'].forEach(function (useragent, idx) {
        var sua = new SUA(useragent);
    ...
    it('ua.xbox.edge', function () {
      useragents['XboxEdge'].forEach(function (useragent, idx) {
        var sua = new SUA(useragent);
        expect(sua.xbox).be.ok;
    ...
    it('ua.google.nexus.player', function () {
      useragents['GoogleNexusPlayer'].forEach(function (useragent, idx) {
        var sua = new SUA(useragent);
